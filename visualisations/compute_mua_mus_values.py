...
fig, ax = plt.subplots(1, 3, figsize=(10, 3.7), layout="constrained")
ax[0].hist(muas_background, bins=15)
ax[0].set_ylabel("Frequency", fontweight="bold")
ax[0].set_xlabel("Absorption Coefficient\n(Background) [cm$^{-1}$]", fontweight="bold")

ax[1].hist(muas_inclusions, bins=15)
ax[1].set_xlabel("Absorption Coefficient\n(Inclusions) [cm$^{-1}$]", fontweight="bold")

ax[2].hist(musps, bins=15)
ax[2].set_xlabel("Reduced Scattering Coefficient\n(All) [cm$^{-1}$]", fontweight="bold")
